...
const ParkingMap: React.FC = () => {
  ...
  const getSlotStyle = (slot: ParkingSlot) => {
    ...
    const style: React.CSSProperties = {
      ...
      width: `${width}px`,
      height: `${height}px`,
      margin: '100px', // Add margin for spacing between slots
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              {/* Zoom Out Button */}
              <button
                onClick={() => setMapScale(Math.max(0.1, mapScale - 0.1))} // Minimum scale is 10% (0.1)
              ...
              {/* Zoom In Button */}
              <button
                onClick={() => setMapScale(Math.min(0.5, mapScale + 0.1))} // Maximum scale is 50% (0.5)
                className="btn btn-outline p-2"
              >
                +
              </button>
